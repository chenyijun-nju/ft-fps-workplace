...
class PSO():
    def __init__(self, pN, dim, max_iter):
        ...
        self.fuzpoint = 50
        self.dbfpt = 2500
        self.EXP = [-0.00175,-0.008,0.0275,-0.0105,-0.0035,0.02575,0.02225,0.00275,0.0185,0.01125,0.0445,-0.003,0.06325,0.017,0.02175,0,0.003,0.009,0.005,0,0.003,0.012,0.009,0.019]
        self.tri = [[-0.134,-0.019,0.165],[-0.138,-0.013,0.132],[0.187,-0.0225,0.342],[-0.181,-0.005,0.149],[-0.111,-0.001,0.099],[-0.229,-0.024,0.38],[-0.13,-0.005,0.229],[-0.212,-0.017,0.257],[-0.144,0.011,0.196],[-0.222,-0.005,0.277],[-0.124,0.019,0.264],[-0.263,-0.038,0.327],[-0.194,0.031,0.385],[-0.174,-0.014,0.27],[-0.215,0.034,0.234]]
        self.nor = [[0,0.053],[0.003,0.053],[0.009,0.053],[0.005,0.042],[0,0.038],[0.003,0.038],[0.012,0.077],[0.009,0.088],[0.019,0.085]]
...
my_pso = PSO(pN=15, dim=26, max_iter=1000)
